...
- [ ] 3c: Cleanup and the finish: remove a task's working folder once it is done or cancelled (moving its agent out first), clear leftovers at startup, and show each mission's branch and how to merge it yourself

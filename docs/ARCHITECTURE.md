...
**What is not built yet:** handing the issue to an agent (8b), pushing and opening a pull request (8c) and following it (8d). Each will preview before any write, log it, and refuse if anything changed since the preview.
